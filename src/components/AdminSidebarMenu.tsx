    ...
    <div className="flex flex-col h-full">
      <div className="flex-1 p-4 space-y-1 mt-10">
        ...
        <button onClick={() => nav("usuarios")}
          className={`flex items-center gap-3 w-full text-left px-3 py-2 rounded-lg text-sm transition-colors ${current === "usuarios" ? "bg-gray-100 dark:bg-gray-800 font-medium" : "hover:bg-gray-50 dark:hover:bg-gray-800"} text-gray-800 dark:text-gray-200`}>
          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <button onClick={() => nav("estadisticas")}
          className={`flex items-center gap-3 w-full text-left px-3 py-2 rounded-lg text-sm transition-colors ${current === "estadisticas" ? "bg-gray-100 dark:bg-gray-800 font-medium" : "hover:bg-gray-50 dark:hover:bg-gray-800"} text-gray-800 dark:text-gray-200`}>
          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
